...
/**
 * This class represents a build models response. It can
 * be sent during the progress of the request to recieve
 * data about the progress and expected time of ending
 * and at the end to get the results.
 *
