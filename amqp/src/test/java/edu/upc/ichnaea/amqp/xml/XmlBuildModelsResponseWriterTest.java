...
public class XmlBuildModelsResponseWriterTest {
    ...
    public void testXML() throws ParserConfigurationException, SAXException,
            IOException, MessagingException, ParseException {
        String id = "455";
        ...
        String rdata = new XmlBuildModelsResponseWriter().build(resp)
                .toString();

        MimeMultipart mp = new MimeMultipart(new ByteArrayDataSource(
                rdata.getBytes(), "multipart/mixed"));
        ...
        String expectedXml = "<response end=\"2012-12-28T22:00:00.000+0100\" id=\"455\" progress=\"1.0\" ";
