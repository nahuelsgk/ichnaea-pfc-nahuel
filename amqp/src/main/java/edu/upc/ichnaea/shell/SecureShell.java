...
public class SecureShell implements ShellInterface {
    ...
    static public SecureShell create(Map<String, String> options)
    ...
    public SecureShell(String urlString, boolean checkHostKey)
            throws MalformedURLException {
        ...
        init(url.getHost(), userInfo[0], userInfo[1], url.getPort(),
                checkHostKey);
    }

    public SecureShell(String host, String user, String password, int port,
            boolean checkHostKey) {
