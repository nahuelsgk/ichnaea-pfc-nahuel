...
public class AgingHandler implements ContentHandler {
        ...
        if (mTrial != null) {
            if (!localName.equalsIgnoreCase(TAG_VALUE)) {
                throw new SAXException(
                        "Only value tags are accepted inside a trial.");
            }
            ...
            if (!localName.equalsIgnoreCase(TAG_TRIAL)) {
                throw new SAXException(
                        "Only trial tags are accepted inside an aging.");
            }
    ...
    public void endElement(String uri, String localName, String qName)
        ...
        if (localName.equalsIgnoreCase(TAG_VALUE)) {
            if (mTrial == null) {
                throw new SAXException(
                        "Value tags can only be inside trial tags.");
            }
            ...
            if (mAging == null) {
                throw new SAXException(
                        "Trial tags can only be inside aging tags.");
            }
