...
public class BuildModelsRequestApp extends App {
    ...
    protected Options getOptions() {
        ...
        }.setDefaultValue(mAgingPath).setDescription(
                "The path where the aging files are kept."));
        options.add(new StringOption("aging-positions") {
            @Override
            public void setValue(String value) {
                mAgingPositions = value;
            }
        }.setDefaultValue(mAgingPositions).setDescription(
                "The list of positions of the agings."));
    ...
    protected void setup() throws IOException {
        ...
        mClient = new BuildModelsRequestClient(request, mRequestQueue,
