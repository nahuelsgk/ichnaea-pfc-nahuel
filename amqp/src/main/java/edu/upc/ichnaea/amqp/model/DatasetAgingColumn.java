...
/**
 * Model class that represents all the aging data for a dataset column. Index
 * for an aging is a float that represents the position of the aging inside a
 * timeline (For example Winter=0.0, Summer=0.5).
 * 
 * @author mibero
 */
