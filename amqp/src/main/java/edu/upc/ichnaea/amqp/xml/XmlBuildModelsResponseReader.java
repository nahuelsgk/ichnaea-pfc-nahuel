...
public class XmlBuildModelsResponseReader extends
        XmlReader<BuildModelsResponseHandler> {
    ...
    public BuildModelsResponse read(String mpdata) throws SAXException,
