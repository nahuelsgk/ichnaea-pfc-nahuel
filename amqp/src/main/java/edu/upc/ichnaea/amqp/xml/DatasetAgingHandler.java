        ...
        if (mAgingHandler != null) {
            ...
            if (!localName.equalsIgnoreCase(AgingHandler.TAG_AGING)) {
                throw new SAXException(
                        "Only aging tags are accepted inside a column.");
            }
            ...
            if (!localName.equalsIgnoreCase(TAG_COLUMN)) {
                throw new SAXException(
                        "Only column tags are accepted inside dataset agings.");
            }
    ...
    public void endElement(String uri, String localName, String qName)
        ...
        if (mAgingHandler != null) {
            ...
            if (localName.equalsIgnoreCase(AgingHandler.TAG_AGING)) {
                if (mColumn == null) {
                    throw new SAXException(
                            "Aging tags can only be inside column tags.");
                }
            ...
            if (mColumn == null) {
                throw new SAXException(
                        "Column tags can only be inside agings tags.");
            }
