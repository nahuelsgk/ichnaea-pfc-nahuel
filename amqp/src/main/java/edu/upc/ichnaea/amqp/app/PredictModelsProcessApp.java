...
import edu.upc.ichnaea.amqp.client.PredictModelsProcessClient;
import edu.upc.ichnaea.shell.ShellFactory;
import edu.upc.ichnaea.shell.ShellInterface;

public class PredictModelsProcessApp extends App {

    PredictModelsProcessClient mClient;
    String mShell;
    int mFork = 1;
    String mScriptPath = "./ichnaea.sh";
    String mRequestQueue = "ichnaea.predict-models.request";
    String mResponseQueues = "ichnaea.predict-models.response";
    String mResponseExchange = "ichnaea.predict-models.response";
    boolean mVerbose = false;

    public static void main(String[] args) {
        main(args, new PredictModelsProcessApp());
    }
    ...
    protected void setup() throws IOException {
        ...
        mClient = new PredictModelsProcessClient(shell, mScriptPath,
