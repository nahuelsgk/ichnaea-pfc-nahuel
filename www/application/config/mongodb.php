...
$config['default']['mongo_hostbase'] = 'ds059947.mongolab.com:59947';
$config['default']['mongo_database'] = 'ichnaea_test';
$config['default']['mongo_username'] = 'nahuelsgk';
$config['default']['mongo_password'] = '4cL2ea8p';
