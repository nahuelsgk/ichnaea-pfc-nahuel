...
A continuació s'especifica el flux dels casos d'usos i el comportament del sistema en cadascun de ells. En la documentaci\'{o} s'utilitzar\`{a} la següent estructura per definir els casos d'\'{u}s:\\
\begin{usecase}
