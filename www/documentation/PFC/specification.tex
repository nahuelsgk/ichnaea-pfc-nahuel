...
\addfield{Actors:}{Usuari registrat}
\addscenario{Curs tipic d'esdeveniments:}{
    \item L'admininistrador selecciona una variable d'un llistat de variables.
    \item El sistema li mostra un formulari d'edici\'{o} on pot veure les ''season sets'' i els seus components(''seasons'') i pot actualitzar la descripci\'{o}.
    \item L'usuari selecciona una ''season set''.
    \item El sistema li mostra un formulari on
    \begin{itemize}
    \item pot afegir fitxers i configurar-los com cadascun com estiu, hivern, primavera, tardor o tot l'any
    \item esborrar componenents(''seasons'')
    \item actualitzar el nom 
    \end{itemize}
    \item L'usuari actualiza el nom i/o esborra components i/o afegeix components i els configura i guarda els canvis.
    \item El sistema guarda els canvis. 
    \end{itemize}
...
\addfield{Actors:}{Usuari registrat}
\addscenario{Curs tipic d'esdeveniments:}{
    \item L'admininistrador selecciona una variable d'un llistat de variables per esborrar.
