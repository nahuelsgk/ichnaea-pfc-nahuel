...
La aplicaci\'{o} ha de permetre la configuraci\'{o} de les matrius(mirar \ref{cha:backgroud:univers:matrius}):
\begin{itemize}
...
\addfield{Actors:}{Usuari registrat}
\addscenario{Curs t\'{i}pic d'esdeveniments:}{
    \item L'usuari seleccion una variable.
    ...
    \item El sistema esborra tots els fitxers i el conjunt.
}
\addscenario{Cursos alternatius:}{
\item[4] L'usuari cancela la acci\'{o}.
}
\end{usecase}
