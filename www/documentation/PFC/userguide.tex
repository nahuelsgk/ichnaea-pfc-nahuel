...
Si la creaci\'{o} \'e{s} correcte, les dades s'enviaran a la cua de procesos i la aplicaci\'{o} es redirigir\'{a} a la pantalla de visualitzaci\'{o} de entrenaments(mirar la secció \ref{subsec:viewtraining}).
