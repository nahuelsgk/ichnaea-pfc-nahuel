...
\label{cha:tests}
En aquest capítol exposem les proves realitzades de la aplicaci\'{o}.
...
\label{cypruss}
Partim d'una matrius de dades reals proporcionada per Anicet Blanch anomenada \textit{Cypruss}. \'{E}s una matriu composta per 103 mostres de 27 variables(columnes). La importaci\'{o}(creaci\{'} del model de dades a partir d'un fitxer) triga 1226ms i la renderitzaci\'{o} 1066ms. 
