...
Per la implementaci\`{o} del sistema web s'han usat un disseny per capes(Presentaci\'{o}, domini i persistència de dades) amb els seg\¨{u}ents patrons de disseny:
  \begin{itemize}
