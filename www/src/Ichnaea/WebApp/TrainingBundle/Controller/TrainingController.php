...
{
    public function getFormAction($matrix_id)
    {
    	$matrixService = $this->get('ichnaea.service');
    	$n_columns     = $matrixService->getM($matrix_id);
    	 
        return $this->render('IchnaeaWebAppTrainingBundle::form.html.twig', array("matrix_id" => $matrix_id, "n_columns" => $n_columns));
    }
    
    public function postTrainingAction($matrix_id)
    {
    ...
    {
    	return $this->render('IchnaeaWebAppTrainingBundle::form.html.twig', array('matrix_id' => $matrix_id));
    }
